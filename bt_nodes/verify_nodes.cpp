...
int main(int argc, char** argv) {
  ...
  check(factory.size() == 27,
        "注册了 27 个内置节点（含 PrioritySelector 与 TickRate）");
  for (const char* n : {"Sequence", "Fallback", "Parallel", "PrioritySelector", "Inverter",
                        ...
                        "Delay", "WaitUntilElapsed", "TickRate", "LogEvent",
